...
namespace kartEslestir
{
    public partial class NormalGame : Form
    {
        ...
        void newGame()
        {
            ...
            normalGameTimer2.Enabled = true;
            normalGameTimer.Enabled = false;
            ...
            card1.Image = Properties.Resources.BABEL;
            Dupcard1.Image = Properties.Resources.BABEL;

            card2.Image = Properties.Resources.BELHANDA;
            Dupcard2.Image = Properties.Resources.BELHANDA;

            card3.Image = Properties.Resources.DIAGNE;
            Dupcard3.Image = Properties.Resources.DIAGNE;

            card4.Image = Properties.Resources.FALCAO;
            Dupcard4.Image = Properties.Resources.FALCAO;

            card5.Image = Properties.Resources.LUYINDAMA;
            Dupcard5.Image = Properties.Resources.LUYINDAMA;

            card6.Image = Properties.Resources.MARCÃO;
            Dupcard6.Image = Properties.Resources.MARCÃO;

            card7.Image = Properties.Resources.MUSLERA;
            Dupcard7.Image = Properties.Resources.MUSLERA;

            card8.Image = Properties.Resources.TURAN;
            Dupcard8.Image = Properties.Resources.TURAN;
        }

        void EndGame()
        {
            normalGameTimer.Enabled = !normalGameTimer.Enabled;
            lblTimerMes.Text = "";
        ...
        private void normalGameTimer_Tick(object sender, EventArgs e)
        {
        ...
        private void normalGameTimer2_Tick(object sender, EventArgs e)
        {
            if (--startGameTime == 0)
            {
                normalGameTimer2.Enabled = !normalGameTimer2.Enabled;
                lblTimerMes.Text = "";

                timeLeft = 70;
                lblTimer.Text = startGameTime.ToString();
                normalGameTimer.Enabled = true;

                foreach (PictureBox cardPicture in CardsHolder.Controls)
                {
                    cardPicture.Enabled = true;
                    cardPicture.Cursor = Cursors.Hand;
                    cardPicture.Image = Properties.Resources.gsCover;
                }
        ...
        private void normalGameSelectTimer_Tick(object sender, EventArgs e)
        {
            cardMatchTimer--;
            if (cardMatchTimer == 0)
            {
                normalGameSelectTimer.Stop();
                selectImage1.Image = Properties.Resources.gsCover;
                selectImage2.Image = Properties.Resources.gsCover;
